<div class="left-side-menu">
    ...
    <div class="sidebar-icon-menu">
        <!-- LOGO -->
        <div class="logo-box dark-green-bg">
            <!-- Brand Logo Light -->
            <a href="{{route('home')}}" class="text-white">
                <img src="{{asset('images/psirs-logo.png')}}" alt="logo" height="28">
            </a>
        </div>

        <div class="h-100 dark-green-bg" data-simplebar>
            <ul class="menu" id="two-col-sidenav-main">
                <li class="menu-item">
                    <a href="#dashboard" data-bs-title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right"
                ...
                <li class="menu-item">
                    <a href="#pages" data-bs-title="Pages" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-bs-trigger="hover" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="#layouts" data-bs-title="Layouts" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-bs-trigger="hover" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="#ui-elements" data-bs-title="UI Elements" data-bs-toggle="tooltip"
                        data-bs-placement="right" data-bs-trigger="hover" class="menu-link">
                        <span class="menu-icon"><i data-feather="briefcase"></i></span>
                    </a>
                </li>

                <li class="menu-item">
                    <a href="#components" data-bs-title="Components" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-bs-trigger="hover" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="#widgets" data-bs-title="Widgets" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-bs-trigger="hover" class="menu-link">
    ...
    <div class="app-menu">
        ...
        <div class="logo-box">
            ...
            <a href="{{route('home')}}" class="logo-light">
                <img src="{{asset('images/psirs-logo.png')}}" alt="logo" height="45">
                <img src="{{asset('images/psirs-logo.png')}}" alt="small logo" class="logo-sm">
            </a>

            <!-- Brand Logo Dark -->
            <a href="{{route('home')}}" class="logo-dark">
                <img src="{{asset('images/psirs-logo.png')}}" alt="dark logo" height="45">
                <img src="{{asset('images/psirs-logo.png')}}" alt="small logo" class="logo-sm">
            </a>
        </div>
