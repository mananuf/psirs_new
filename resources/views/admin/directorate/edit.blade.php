...
@section('content')
<form action="{{route('admin.directorates.update', $directorate)}}" method="POST" enctype="multipart/form-data">
  @csrf
  @method('PATCH')
  <div class="row">
    <div class="col-lg-6">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="directorate_name" name="title" class="form-control"
              placeholder="e.g : Admin & Planning" value="{{$directorate->title}}">
          </div>
            ...
            <div class="d-flex flex-wrap">
              <div class="form-check me-2">
                <input class="form-check-input" type="radio" name="status"
                  value="{{App\Enums\GenericStatus::enabled()}}" id="inlineRadio1" @if ($directorate->status === App\Enums\GenericStatus::enabled()) checked @endif >
                <label class="form-check-label" for="inlineRadio1">{{__('Enabled')}}</label>
              </div>
              <div class="form-check me-2">
                <input class="form-check-input" type="radio" name="status"
                  value="{{App\Enums\GenericStatus::disabled()}}" id="inlineRadio2" @if ($directorate->status === App\Enums\GenericStatus::disabled()) checked @endif>
  ...
  <div class="row">
    <div class="col-12">
      <div class="text-center mb-3">
        <button type="submit" class="btn w-sm btn-success waves-effect waves-light">{{__('Save Changes')}}</button>
